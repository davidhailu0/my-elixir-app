defmodule MyLiveAppWeb.CounterLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :counters, Pages.list_counters())}
  end
  ...
  @impl true
  def handle_info({MyLiveAppWeb.CounterLive.FormComponent, {:saved, counter}}, socket) do
    {:noreply, stream_insert(socket, :counters, counter)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    counter = Pages.get_counter!(id)
    {:ok, _} = Pages.delete_counter(counter)
